...
public class Gains {
	...
	public boolean equals(Object other) {
		...
		return Double.compare(otherGains.p, p) == 0 && Double.compare(otherGains.i, i) == 0 && Double.compare(otherGains.d, d) == 0 && Double.compare(otherGains.f, f) == 0 && Double.compare(otherGains.iZone, iZone) == 0 && Double.compare(otherGains.iMax, iMax) == 0;
	}
