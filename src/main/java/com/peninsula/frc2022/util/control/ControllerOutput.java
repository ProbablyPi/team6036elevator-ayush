...
public class ControllerOutput {
	...
	public boolean equals(Object other) {
		...
		return Double.compare(otherOutput.mReference, mReference) == 0 && Double.compare(otherOutput.mArbitraryDemand, mArbitraryDemand) == 0 && Objects.equals(mMode, otherOutput.mMode) && Objects.equals(mGains, otherOutput.mGains);
	}
