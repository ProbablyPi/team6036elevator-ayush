...
public class ProfiledGains extends Gains {
	...
	public boolean equals(Object other) {
		...
		return Double.compare(otherGains.acceleration, acceleration) == 0 && Double.compare(otherGains.velocity, velocity) == 0 && Double.compare(otherGains.allowableError, allowableError) == 0 && Double.compare(otherGains.minimumOutputVelocity, minimumOutputVelocity) == 0;
	}
