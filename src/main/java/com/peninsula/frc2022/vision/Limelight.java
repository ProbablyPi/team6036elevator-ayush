package com.peninsula.frc2022.vision;

import com.peninsula.frc2022.vision.LimelightControlMode.*;
...
//  private static final NetworkTableInstance sNetworkTableInstance =
...
//
//  /**
//   * @return The pipeline’s latency contribution (ms) Add at least 11ms for image capture
// latency.
//   */
...
//
//  /**
//   * @param stream {@link StreamType#STANDARD} - Side-by-side streams if a web-cam is attached
// to
...
//   *     primary camera stream is placed in the lower-right corner of the secondary camera
// stream
//   */
...
//
//  /**
//   * Limelight posts three raw contours to NetworkTables that are not influenced by your
// grouping
...
//    //		double add = _controller.getRightY();
